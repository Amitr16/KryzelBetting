...
def test_settlement_341057():
    """Test the settlement logic for match 341057"""
    ...
    with app.app_context():
        ...
        bet = Bet.query.filter_by(match_id='341057').first()
        ...
        if bet:
            ...
            match_event = settlement_service._find_match_in_historical_data('341057', bet.match_name)
