...
def map_market_to_frontend(market_name):
    ...
    market_mapping = {
        ...
        'over/under': 'over_under',   # Cricket total runs over/under
        'most run outs': 'most_run_outs',
        ...
        'both_teams_score': 'both_teams_score',  # Direct mapping
        'correct score': 'correct_score',
        'asian handicap': 'asian_handicap',
        '2nd half winner': 'second_half_winner',
        ...
        'correct score 2nd half': 'correct_score_second_half',
        'double chance': 'double_chance',
        '1st half winner': 'first_half_winner',
        'first_half_winner': 'first_half_winner',  # Direct mapping
        'team to score first': 'team_to_score_first',
        'win both halves': 'win_both_halves',
        'double chance - 1st half': 'double_chance_first_half',
        'double chance - 2nd half': 'double_chance_second_half',
        'both teams to score - 1st half': 'both_teams_score_first_half',
        'both teams to score - 2nd half': 'both_teams_score_second_half',
        'odd/even': 'odd_even',
        'odd/even 1st half': 'odd_even_first_half',
